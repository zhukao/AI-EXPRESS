# Install script for directory: /data/qingpeng.liu/nfs/github/0912_ai_express_release/source/solution_zoo/tools/xwarehouse
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample")
...
file(INSTALL DESTINATION "/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample" TYPE EXECUTABLE FILES "/data/qingpeng.liu/nfs/github/0912_ai_express_release/build/bin/xwarehouse_sample")
  if(EXISTS "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample"
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/xwarehouse_sample/xwarehouse_sample")
    endif()
  endif()
endif()

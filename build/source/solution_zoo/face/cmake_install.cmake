# Install script for directory: /data/qingpeng.liu/nfs/github/0912_ai_express_release/source/solution_zoo/face
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/data/qingpeng.liu/nfs/github/0912_ai_express_release/output//face_solution//configs//")
...
file(INSTALL DESTINATION "/data/qingpeng.liu/nfs/github/0912_ai_express_release/output//face_solution//configs/" TYPE DIRECTORY FILES "/data/qingpeng.liu/nfs/github/0912_ai_express_release/source/solution_zoo/face/configs/")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution" TYPE EXECUTABLE FILES "/data/qingpeng.liu/nfs/github/0912_ai_express_release/build/bin/face_solution")
  if(EXISTS "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution"
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/data/qingpeng.liu/nfs/github/0912_ai_express_release/output/face_solution/face_solution")
    endif()
  endif()
endif()

...
#ifndef TEST_INCLUDE_HOBOTXSTREAM_C_DATA_TYPES_ARRAY_H_
#define TEST_INCLUDE_HOBOTXSTREAM_C_DATA_TYPES_ARRAY_H_
...
#define XSTREAM_CAPI_INHERIT_FROM_ARRAY(ChildType, size)                     \
  ...
  inline void HobotXStreamCapi##ChildType##Free(                             \
      HobotXStreamCapi##ChildType** data) {                                  \
    free((*data)->values_);                                                  \
...
#endif  // TEST_INCLUDE_HOBOTXSTREAM_C_DATA_TYPES_ARRAY_H_

...
#ifndef INCLUDE_HOBOTXSTREAM_IMAGETOOLS_CONVERTOR_H_
#define INCLUDE_HOBOTXSTREAM_IMAGETOOLS_CONVERTOR_H_
...
#endif  // INCLUDE_HOBOTXSTREAM_IMAGETOOLS_CONVERTOR_H_

...
#ifndef INCLUDE_HOBOTXSTREAM_IMAGETOOLS_BASE_H_
#define INCLUDE_HOBOTXSTREAM_IMAGETOOLS_BASE_H_
...
class ImageBase {
 ...
 protected:
  ...
  HobotXStreamImageToolsPixelFormat input_fmt_;
  ...
  HobotXStreamImageToolsPixelFormat output_fmt_;
};

}  // namespace xstream

#endif  // INCLUDE_HOBOTXSTREAM_IMAGETOOLS_BASE_H_

 ...
 * @brief     provides common types of xstream image tools interface
 * @author    hangjun.yang
 * @email     hangjun.yang@horizon.ai
 * @version   0.0.0.1
 * @date      2018.12.10
 */
#ifndef INCLUDE_HOBOTXSTREAM_IMAGETOOLS_COMMON_H_
#define INCLUDE_HOBOTXSTREAM_IMAGETOOLS_COMMON_H_
#include <assert.h>
...
struct ImageToolsFormatData {
  ...
  HobotXStreamImageToolsPixelFormat format_;
...
#endif  // INCLUDE_HOBOTXSTREAM_IMAGETOOLS_COMMON_H_

 ...
 * @date      2018.12.07
 */
#ifndef INCLUDE_HOBOTXSTREAM_IMAGE_TOOLS_H_
#define INCLUDE_HOBOTXSTREAM_IMAGE_TOOLS_H_
#include <stdint.h>
...
#ifdef __cplusplus
#define XSTREAM_API  extern "C" IMAGETOOLS_EXPORT
#else
#define XSTREAM_API IMAGETOOLS_EXPORT
#endif

enum HobotXStreamImageToolsPixelFormat {
...
struct HobotXStreamImageToolsResizeInfo {

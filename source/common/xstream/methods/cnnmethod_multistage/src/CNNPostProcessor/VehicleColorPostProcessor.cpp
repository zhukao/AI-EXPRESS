 ...
 * @File: VehicleColorPostProcessor.cpp
 * @Brief: definition of the VehicleColorPostProcessor
 * @Author: yatao.fu
...
namespace xstream {
namespace CnnProc {
DEFINE_MethodCreator(vehicle_color_post, VehicleColorPostProcessor())

int VehicleColorPostProcessor::Init(const std::string &cfg_path) {
  CNNPostProcessor::Init(cfg_path);
  return 0;
}

std::vector<std::vector<BaseDataPtr>>
  VehicleColorPostProcessor::DoProcess(
...
int VehicleColorPostProcessor::VehicleTColorPro(

...
void DumpPoseLmk(const std::vector<BaseDataPtr> &,
                 std::ostream &, std::string);
void DumpAgeGender(const std::vector<BaseDataPtr> &,
                   std::ostream &, std::string);
void DumpAntiSpf(const std::vector<BaseDataPtr> &,
                 std::ostream &, std::string);
void DumpFaceQuality(const std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
void DumpVehicleColor(std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
void DumpVehicleType(std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
void DumpPlateNum(std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
void DumpVehiclePhone(std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
void DumpVehicleBelt(std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
void DumpPersonAttrs(std::vector<BaseDataPtr> &,
                     std::ostream &, std::string);
...
void DumpAntiSpf(const std::vector<xstream::BaseDataPtr> &result,
                 std::ostream &os,
                 std::string id) {
  os << id;
  std::vector<float> rlts;
...
void DumpAgeGender(const std::vector<xstream::BaseDataPtr> &result,
                   std::ostream &os,
                   std::string id) {
  os << id;
...
void DumpPoseLmk(const std::vector<xstream::BaseDataPtr> &result,
                 std::ostream &os,
                 std::string id) {
  os << id;
...
void DumpFaceQuality(const std::vector<BaseDataPtr> &result,
                     std::ostream &os,
                     std::string id) {
  os << id;
  ...
  for (int target_idx = 0; target_idx < target_size; target_idx++) {
    ...
    os << " " << roi->value.x1 << " " << roi->value.y1 << " " << roi->value.x2
       << " " << roi->value.y2;
    for (std::size_t attr_idx = 1; attr_idx < result.size(); attr_idx++) {
      auto attrs =

...
const ::x3::CaptureTarget& CaptureFrameMessage::targets_(int index) const {
  // @@protoc_insertion_point(field_get:x3.CaptureFrameMessage.targets_)
  return targets__.Get(index);
}
::x3::CaptureTarget* CaptureFrameMessage::mutable_targets_(int index) {
  // @@protoc_insertion_point(field_mutable:x3.CaptureFrameMessage.targets_)
  return targets__.Mutable(index);
}
::x3::CaptureTarget* CaptureFrameMessage::add_targets_() {
...
void FrameMessage::InitAsDefaultInstance() {
  _is_default_instance_ = true;
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  smart_msg__ = const_cast< ::x3::SmartFrameMessage*>(
      ::x3::SmartFrameMessage::internal_default_instance());
#else
  smart_msg__ = const_cast< ::x3::SmartFrameMessage*>(&::x3::SmartFrameMessage::default_instance());
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  capture_msg__ = const_cast< ::x3::CaptureFrameMessage*>(
      ::x3::CaptureFrameMessage::internal_default_instance());
#else
  capture_msg__ = const_cast< ::x3::CaptureFrameMessage*>(&::x3::CaptureFrameMessage::default_instance());
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(FrameMessage, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  &reinterpret_cast<FrameMessage*>(16)->f)
#endif
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .x3.SmartFrameMessage smart_msg_ = 1;
      case 1: {
        if (tag == 10) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
      ...
      // optional .x3.CaptureFrameMessage capture_msg_ = 2;
      case 2: {
        if (tag == 18) {
         parse_capture_msg_:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
        ...
        if (input->ExpectTag(26)) goto parse_Statistics_msg_;
        break;
      }

      // optional .x3.StatisticsMessage Statistics_msg_ = 3;
      case 3: {
        if (tag == 26) {
        ...
        if (input->ExpectTag(34)) goto parse_img_;
        break;
      }

      // optional .x3.Image img_ = 4;
      case 4: {
        if (tag == 34) {
         parse_img_:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
        ...
        if (input->ExpectTag(41)) goto parse_timestamp_;
        break;
      }

      // optional fixed64 timestamp_ = 5;
      case 5: {
        if (tag == 41) {
         parse_timestamp_:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
        ...
        if (input->ExpectTag(48)) goto parse_sequence_id_;
        break;
      }

      // optional uint64 sequence_id_ = 6;
      case 6: {
        if (tag == 48) {
         parse_sequence_id_:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
...
void FrameMessage::SerializeWithCachedSizes(
  ...
  if (this->has_statistics_msg_()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      3, *this->statistics_msg__, output);
  }
...
const ::x3::SmartFrameMessage& FrameMessage::smart_msg_() const {
...
::x3::SmartFrameMessage* FrameMessage::mutable_smart_msg_() {
  
  if (smart_msg__ == NULL) {
    smart_msg__ = new ::x3::SmartFrameMessage;
  }
  // @@protoc_insertion_point(field_mutable:x3.FrameMessage.smart_msg_)
  return smart_msg__;
}
::x3::SmartFrameMessage* FrameMessage::release_smart_msg_() {
...
void FrameMessage::set_allocated_smart_msg_(::x3::SmartFrameMessage* smart_msg_) {
  delete smart_msg__;
...
const ::x3::CaptureFrameMessage& FrameMessage::capture_msg_() const {
...
::x3::CaptureFrameMessage* FrameMessage::mutable_capture_msg_() {
  
  if (capture_msg__ == NULL) {
    capture_msg__ = new ::x3::CaptureFrameMessage;
  }
  // @@protoc_insertion_point(field_mutable:x3.FrameMessage.capture_msg_)
  return capture_msg__;
}
::x3::CaptureFrameMessage* FrameMessage::release_capture_msg_() {
...
void FrameMessage::set_allocated_capture_msg_(::x3::CaptureFrameMessage* capture_msg_) {
  delete capture_msg__;
...
// optional uint64 sequence_id_ = 6;
void FrameMessage::clear_sequence_id_() {
  sequence_id__ = GOOGLE_ULONGLONG(0);
}
 ::google::protobuf::uint64 FrameMessage::sequence_id_() const {
  // @@protoc_insertion_point(field_get:x3.FrameMessage.sequence_id_)
  return sequence_id__;
}
 void FrameMessage::set_sequence_id_(::google::protobuf::uint64 value) {

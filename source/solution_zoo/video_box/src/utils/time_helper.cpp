...
double
Timer::toc_s(const std::chrono::time_point<std::chrono::system_clock> &tic) {
  auto time_d = std::chrono::duration_cast<std::chrono::microseconds>(
...
double
Timer::toc(const std::chrono::time_point<std::chrono::system_clock> &tic) {
